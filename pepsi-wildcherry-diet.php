...
<head>
    ...
    <title>Pepsi</title>
    <link rel="stylesheet" href="css/pepsi-wildcherry-diet.css">
</head>
<body>
    <main>
        <header>
        ...
        <div class="hoja">
            <div class="info_nutri">
                <h1 class="nombre-bebida">PEPSI WILDCHERRY DIET</h1>
                <hr class="linea">
               ...
               <div><p class="derecha">% Valor diario</p></div> 
                ...
                <hr>
                <p class="ingredientes">AGUA CARBONATADA , COLOR CARAMELO , ÁCIDO FOSFÓRICO , SABOR NATURAL , ASPARTAMO , BENZOATO DE POTASIO (CONSERVA LA FRESCURA) , CITRATO DE POTASIO , ÁCIDO CÍTRICO , CAFEÍNA , ACESULFAMO DE POTASIO , EDTA DISÓDICO DE CALCIO (PARA PROTEGER EL SABOR)</p>
            </div>
        </div>
        </div>
             <div class="flechas">
                <a class="flecha-derecha" href="pepsi-wildcherry-zero.php">←</a>
                <a class="flecha-izquierda" href="pepsi-caffeine-free.php">→</a>
            </div>
    </main>
