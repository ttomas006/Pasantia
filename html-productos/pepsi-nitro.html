...
<head>
    ...
    <title>Pepsi</title>
    <link rel="stylesheet" href="css/pepsi-nitro.css">
</head>
<body>
    <main>
        <header>
        ...
        <div class="hoja">
            <div class="info_nutri">
               ...
               <div><p class="derecha">% Valor diario</p></div> 
                ...
                <div class="kiko">
                 <p>Carbohidratos totales: 62g</p>   
                 <p>21 %</p>  
                </div>
                <p>Azúcares: 62g</p>    
                <p id="proteina">Proteína: 0g</p>
                <hr>
                <p class="ingredientes">AGUA CARBONATADA , JARABE DE MAÍZ DE ALTA FRUCTOSA ,COLOR CARAMELO , SABOR NATURAL ,POLIFOSFATO DE SODIO (PARA PROTEGER EL SABOR) ,ÁCIDO FOSFÓRICO , CAFEÍNA , BENZOATO DE SODIO (CONSERVA LA FRESCURA) ,SORBATO DE POTASIO (CONSERVA LA FRESCURA) ,ÁCIDO TARTÁRICO ,GOMA ARÁBIGA , ÁCIDO CÍTRICO , SAL , EXTRACTO DE QUILAYA , EDTA DISÓDICO DE CALCIO (PARA PROTEGER EL SABOR) , NITRÓGENO</p>
            </div>
        </div>
        </div>
              <div class="flechas">
                <a class="flecha-derecha" href="pepsi-nitro-vainilla.html">←</a>
                <a class="flecha-izquierda" href="pepsi-mango.html">→</a>
            </div>
    </main>
