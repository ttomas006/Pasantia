...
<head>
    ...
    <title>Pepsi</title>
    <link rel="stylesheet" href="css/pepsi-real-sugar.css">
</head>
<body>
    <main>
        <header>
        ...
        <div class="hoja">
            <div class="info_nutri">
                <h1 class="nombre-bebida">PEPSI REAL SUGAR</h1>
                <hr class="linea">
               ...
               <div><p class="derecha">% Valor diario</p></div> 
                ...
                <div class="kiko">
                 <p>Carbohidratos totales: 40g</p>   
                 <p>13 %</p>  
                </div>
                <p>Azúcares: 40g</p>    
                <p id="proteina">Proteína: 0g</p>
                <hr>
                <p class="ingredientes">CARBONATED WATER, SUGAR, CARAMEL COLOR, PHOSPHORIC ACID, CAFFEINE, NATURAL FLAVOR</p>
            </div>
        </div>
        </div>
             <div class="flechas">
                <a class="flecha-derecha" href="pepsi-diet-caffeine-free.php">←</a>
                <a class="flecha-izquierda" href="pepsi-wildcherry-and-cream.php">→</a>
            </div>
    </main>
